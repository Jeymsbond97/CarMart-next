			...
			<Stack className={'events'}>
				<Stack className={'container'}>
					<Stack className={'info-box1'}>
						<p className='title'>Your One-Stop Solution for Buying and Selling Cars </p>
						<p className='desc'>Explore thousands of listings or sell your car in just a few clicks.</p>
					</Stack>
					<Stack className={'card-wrapper'}>
						...
						<Box className={'service-card sell-card'}>
							<Box className={'card-content'}>
								<h2 style={{marginLeft: '-25px'}}>Do You Want to Sell a Car ?</h2>
